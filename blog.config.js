...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ming', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '随便写写', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mail@liziming0703@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  PRISM_THEME_LIGHT_PATH:
    ...
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-cb.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-cb.css', // 深色模式主题
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'blog', // 站点描述，被notion中的页面描述覆盖
